...
local default_config = {
  ...
  overrides = {
    ...
    GitSignsAdd = { fg = "#a9b665", bg = "#101010" },
    GitSignsChange = { fg = "#d8a657", bg = "#101010" },
    GitSignsDelete = { fg = "#ea6962", bg = "#101010" },
    GitSignsTopdelete = { fg = "#ea6962", bg = "#101010" },
    GitSignsChangedelete = { fg = "#d8a657", bg = "#101010" },
    GitSignsUntracked = { fg = "#7daea3", bg = "#101010" },
    GitSignsStagedAdd = { fg = "#6c7842", bg = "#101010" },
    GitSignsStagedChange = { fg = "#8a6d39", bg = "#101010" },
    GitSignsStagedDelete = { fg = "#94433f", bg = "#101010" },
    GitSignsStagedTopdelete = { fg = "#94433f", bg = "#101010" },
    GitSignsStagedChangedelete = { fg = "#8a6d39", bg = "#101010" },
    LineNr = { bg = "#101010" },
    ...
    BlinkCmpMenuBorder = { fg = "#3c3836", bg = "#101010" },
    BlinkCmpMenuSelection = { bg = "#3c3836", bold = true },
    BlinkCmpDoc = { bg = "#101010" },
    BlinkCmpDocBorder = { fg = "#3c3836", bg = "#101010" },
    BlinkCmpDocSeparator = { fg = "#3c3836", bg = "#101010" },
    BlinkCmpSignatureHelp = { bg = "#101010" },
    BlinkCmpSignatureHelpBorder = { fg = "#3c3836", bg = "#101010" },
  },
  dim_inactive = false,
